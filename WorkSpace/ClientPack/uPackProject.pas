...
begin
  Result := FormatPath(ProjectInfo.DirectoryInfo.Bin);
end;
...
begin
  Result := FormatPath(ProjectInfo.DirectoryInfo.dcu);
end;
...
begin
  Result := FormatPath(FormatPath(ProjectInfo.DirectoryInfo.Bin) + ProjectInfo.exeName);
end;
