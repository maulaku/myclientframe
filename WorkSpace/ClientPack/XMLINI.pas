...
{*                                        *}
{* TXMLINI class provides methods to read *}
{* and write from XML files in style of   *}
{* using INI files using "normal"         *}
{* TIniFile class.                        *}
{*                                        *}
{* (C) by Ktos 2004-2005                  *}
{* mailto: marcin.ktos@gmail.com          *}
{* www: http://www.ktos.info              *}
{* www2: http://txmlini.sourceforge.net   *}
{*                                        *}
{* Udostêpnione na licencji GNU LGPL      *}
...
{* 28.04.05 10:25 v.1.083 [Ktos]          *}
{* - poprawienie b³êdu #1191158           *}
{* 19.09.05 11:42 v.1.09 [Ktos]           *}
{* - zmiana licencji na GNU LGPL          *}
{* - ostatnia wersja TXMLINI 1.x          *}
{******************************************}
